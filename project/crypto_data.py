# Cryptocurrency database with sustainability and market data (properties like name, symbol, price trend, market cap, energy use, sustainability score, and description).
crypto_data = {
    "bitcoin": {
        "name": "Bitcoin",
        "symbol": "BTC",
